...
function AboutSection3({ data, split }) {
  ...
  return (
    ...
    >
      <div className="w-full relative sliderContainer flex items-center justify-center overflow-x-hidden space-y-8 py-12 sm:py-32 md:py-36 h-fit flex-col">
