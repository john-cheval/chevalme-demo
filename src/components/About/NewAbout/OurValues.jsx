...
const OurValues = ({ valuesData }) => {
  return (
    <div className="  z-[30] relative">
      <div className=" pt-10 lg:pt-16" style={{ zIndex: 4 }}>
        ...
        <div className="md:hidden">
          <OurValuesInnerMobile />
        </div>

        <div className="grid grid-cols-1  lg:grid-cols-12  pt-12  pb-10  rounded-[30px]  gap-x-3 space-y-4 lg:space-y-0 px-3">
