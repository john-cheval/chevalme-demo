...
const VerticalStackCards = ({ cardData }) => {
  return (
    <div className="relative min-h-screen px-5 sm:px-10 md:px-12">
      <div
        className="px-5 sm:px-10 pt-14 md:px-12 w-full h-[465px] sticky top-0 bg-[#141414] lg:rounded-tr-[60px] lg:rounded-tl-[60px] overflow-hidden"
        style={{ zIndex: 1 }}
      >
      ...
      <div
        className="-mt-16 w-full h-[465px] sticky top-0 lg:rounded-tr-[60px] lg:rounded-tl-[60px] overflow-hidden"
        style={{ zIndex: 2 }}
      >
        <Image
      ...
      <div
        className="px-5 sm:px-10 md:px-12 -mt-16 w-full h-[465px] sticky top-0 pt-14 bg-[#fff] lg:rounded-tr-[60px] lg:rounded-tl-[60px] overflow-hidden"
        style={{ zIndex: 3 }}
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 md:gap-x-5 gap-y-4 lg:gap-y-0">
          <h3
