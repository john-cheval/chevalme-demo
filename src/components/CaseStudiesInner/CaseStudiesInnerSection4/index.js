      ...
      <div className="relative max-w-screen mx-auto w-full">
        <div className="w-full flex items-center py-10 sm:py-20 h-fit flex-col ">
          ...
          <ChildrenReveal x={20} y={0} styling="relative  w-full">
            <div className="overflow-hidden pt-5 sm:pt-10 md:pt-12 w-full">
              <div
                style={{
...
export default CaseStudiesInnerSection4;
