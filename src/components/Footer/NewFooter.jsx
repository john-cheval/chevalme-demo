      ...
      <div className="w-full  pb-5 pt-10 md:pt-16 lg:pt-[86px]   px-5 sm:px-10 md:px-12  ">
        ...
        <div className="flex flex-col">
          ...
          <div className="w-full pt-0 sm:pt-10-- z-50 pb-5 hidden md:block">
            <div
              className={
                "grid grid-cols-12 gap-3 lg:gap-4 xl:gap-6 justify-items-center xl:justify-items-start  "
              }
            >
              <div className="md:flex hidden  col-span-6 flex-row space-x-4  xl:space-x-5 mt-5 xl:mt-0 items-end ">
          ...
          <div className="md:hidden w-full mt-9">
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between items-center mt-6 md:hidden space-y-4 sm:space-y-0">
              <div className="flex flex-col xl:flex-row  xl:space-x-5 ">
                <Link
                  href={"/privacy-policy"}
                  className="text-white text-base font-satoshi font-normal leading-[217%] text-center hover:bg-[#d81100] duration-300 transition-all"
                >
                  Privacy Policy
                </Link>
              ...
              <Link
                href={"#"}
                className="sm:h-[78px] sm:w-[78px] h-[50px] w-[50px] rounded-full  items-center justify-center border border-white hover:border-[#d81100] duration-300 transition-all hidden-- flex  "
              >
                <Image
                  src={arrowForward}
                  alt="arrow_forward"
