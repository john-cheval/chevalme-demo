...
import image4 from "../../../../public/abudhabi/6.jpeg";
      ...
      <div className="relative w-screen h-fit  space-y-12 pt-24 sm:pt-28 md:pt-36 pb-20 sm:space-y-14 md:space-y-16 flex items-center flex-col bg-white overflow-x-hidden">
        <div className="w-full   h-fit  px-5 sm:px-10 md:px-12">
          <div className="flex items-start xl:space-y-0 space-y-4 xl:items-end xl:flex-row flex-col justify-between w-full">
            <h1 className="capitalize font-sora font-bold max-w-[590px] md:leading-tight sm:leading-tight leading-tight   text-[#101763] text-3xl sm:text-4xl md:text-5xl">
        ...
        <div className="w-full pl-5 sm:pl-10 md:pl-12 ">
          <div className=" w-full relative">
            <Image
              ...
              alt="abudhabi"
            />
            {/* <div className="flex absolute bottom-0 right-0 m-10 items-center justify-between py-2.5 text-white space-x-2 rounded-[50px] sm:w-fit w-full  px-4 border border-white  bg-transparent  font-sora text-center text-sm ">
          ...
          {/* <div className="col-span-1 relative">
            <Image
              src={image}
              className="h-[530px] w-full object-cover object-center"
            />
          </div> */}
        </div>
        <div className="w-full   h-fit  px-5 sm:px-10 md:px-12">
        ...
        <div className="w-full h-fit px-5 sm:px-10 md:px-12">
          <div className="w-full grid grid-cols-3 grid-flow-row gap-4">
            ...
            <div className="flex relative rounded-lg col-span-1 bg-[#F2F4F9] w-full h-full">
              <Link href={"/projects"}>
        ...
        <div className="w-full h-fit px-5 sm:px-10 md:px-12">
          <div className="w-full h-[650px] relative grid grid-cols-2  gap-3">
            <div className="col-span-1 flex-col w-full flex items-end justify-end relative h-full">
              <Image
                src={image2}
              ...
              <div className="flex w-full  h-fit bg-[#27172F] rounded-b-lg flex-col pb-14 space-y-4  z-20 px-14">
                <h3
                  style={{
                    background:
                ...
                <p className="font-satoshi w-full paragraphText-Size text-white ">
            ...
            <div className="col-span-1 flex-col w-full flex items-end justify-end relative h-full">
              ...
              />
              {/* <div className=" w-full h-full bg-gradient-to-b from-transparent rounded-t-lg to-[#27172F] to-95% z-20"></div> */}
              <div className="flex w-full  h-fit  rounded-b-lg flex-col pb-14 space-y-4  z-20 px-14">
                <h3 className="font-sora font-semibold text-white text-4xl  leading-normal ">
