...
const WeServe = () => {
  return (
    <div className="col-span-3 lg:col-span-2 h-fit w-full grid text-[#27172F] grid-cols-2">
      ...
      <div className="py-6 col-span-2 md:col-span-1 text-base   sm:text-xl font-normal flex leading-none items-center gap-x-4 md:gap-x-6 px-3 uppercase justify-center md:justify-start">
