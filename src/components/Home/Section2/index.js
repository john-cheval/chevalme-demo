            ...
            >
              <div className="flex  flex-col h-fit  space-y-2 sm:space-y-4-- md:space-y-3-- w-full items-center  sm:max-w-fit--   justify-center sm:items-start sm:justify-start md:w-1/2  ">
                ...
                <p
                  ...
                  className="font-satoshi  w-full text-[15px] md:text-base  sm:text-left text-center text-[#101763]"
                ></p>
              </div>
              <div
                className="flex flex-col  md:w-1/2 mt-4 md:mt-5 overflow-visible lg:mt-10 items-center sm:items-end sm:h-[310px] h-[200px]  xl:h-80 md:pl-[4%]   md:space-y-6"
